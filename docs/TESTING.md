...
| Cursor/Claude session tagged `project=0.7.153` | Hook cwd was the plugin cache version dir. | Source: `isPluginInstallCwd` + `resolveWorkspaceCwd`; `deriveProjectKey` does not hash plugin dirs. |

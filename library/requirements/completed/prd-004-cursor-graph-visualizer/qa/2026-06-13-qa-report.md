...
| AC-7 no snapshot → "no graph yet" + Build action to 003b | Partial | `dashboard-shell.ts:332-334` shows text "Run memoree graph build" (CLI string), no in-pane Build button routing to 003b | F-05 |

...
const PLUGIN_ID = "memoree@memoree";

/**
 * Returns false if the user explicitly disabled the memoree plugin via
 * `claude plugin disable memoree` (which writes enabledPlugins[id]=false to
 ...
 */
export function isMemoreePluginEnabled(): boolean {
  try {
